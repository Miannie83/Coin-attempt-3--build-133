...
DZAI_heliList = [["UH1H_DZ",1],["UH60M_EP1_DZ",1],["UH1Y_DZ",1]];
...
DZAI_vehList = [["ArmoredSUV_PMC_DZ",1],["BAF_Jackal2_L2A1_W",1],["HMMWV_M2",1],["LandRover_MG_TK_EP1",1],["SUV_Camo",1],["UAZ_Unarmed_TK_CIV_EP1",1],["Ikarus",1],["350z_pink",1],["MTVR",1],["VWGolf",1]],;
